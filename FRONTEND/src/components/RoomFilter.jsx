...
function RoomFilter({ filters, setFilters, availableTypes, availableFacilities }) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md mb-8">
      <h3 className="text-2xl font-bold text-gray-800 mb-4">Filter Kamar</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <select value={filters.type} onChange={handleTypeChange} className="input-style w-full">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-2">
            {availableFacilities.map(facility => (
              <label key={facility} className="flex items-center space-x-2 text-sm text-gray-600">
                <input
                  type="checkbox"
                  value={facility}
